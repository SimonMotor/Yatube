...
class PostTestCase(TestCase):
    ...
    def test_signup(self):
        response = self.client.get(reverse("profile", kwargs={"username": "m_smith"}))
    ...
    def test_new_post(self):
        ...
        self.client.post(reverse(
            "new_post"), {"text": msg, "group": self.group.pk}, follow=True)
    ...
    def test_post_edit(self):
        ...
        self.client.post(reverse("post_edit",
                                 kwargs={"username": "m_smith",
                                         "post_id": post.pk}),
                         {"text": msg, "group": self.group.pk}, follow=True, )
